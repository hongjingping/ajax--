...
function initGuide() {
    ...
    */
	...
	//解决遮罩层不能覆盖整个页面bug, Modify By Yin,Taizhou
    domMask.style.width = '100%';
    domMask.style.height = '100%';
    domMask.style.position = "fixed";
}
...
guideContainer.innerHTML = [
    ...
    '<a onclick="_addStat(\'apidoc_guide8\')" href="http://developer.baidu.com/map/geosdk.htm" target="_blank">Android定位</a>',
	...
	'<div class="item_right">',
    '<div class="guide_icon">',
    '<div class="process" style="background:url(static/img/nav_icon.png) no-repeat;"></div>',
    '</div>',
    '<div class="guide_text">',
    '<div class="text_title">我要导航</div>',
    '<div class="text_tip">',
    '<span>Android导航</span>(<a href="http://developer.baidu.com/map/navsdk.htm" target="_blank">在线</a>',
    '<a href="http://developer.baidu.com/map/android-fullnavsdk.htm" target="_blank" style="padding-right:0;">离线</a>)',
	'<span style="padding-left:5px;">iOS导航</span>(<a href="http://developer.baidu.com/map/sdk-nav-ios.htm" target="_blank">在线</a>',
    '<a href="http://developer.baidu.com/map/ios-fullnavsdk.htm" target="_blank" style="padding-right:0;">离线</a>)',       
    '</div>',
    '</div>',
    '</div>',
    '</div>',
